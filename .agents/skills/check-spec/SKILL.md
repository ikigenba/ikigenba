---
name: check-spec
description: Report whether a design is buildable — AGENTS.md declared, external facts proven, boundary respected — and show the gap. Feedback only: it gates nothing, commits nothing, and changes nothing.
---

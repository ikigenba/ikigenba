# scripts/project — workspace layout

Everything the scripts service needs to be **designed, planned, and built**
...
root** (`scripts/`), which is also the directory the `ralph` build loop runs
from.

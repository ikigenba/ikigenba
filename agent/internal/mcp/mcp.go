...
// ikigenba_agent_* tool surface.
//
// This is the skeleton agent service: the only tool is ikigenba_agent_health, the
	...
	case "initialize":
		writeJSONRPCResult(w, req.ID, map[string]any{
			...
			"instructions": "Agent runs sandboxed Claude agent sessions on your behalf. " +
				"If you haven't used agent before, call ikigenba_agent_describe first — it explains " +

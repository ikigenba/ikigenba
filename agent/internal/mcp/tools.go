...
const toolPrefix = "ikigenba_agent_"

// tool returns the branded MCP tool name for a verb.
func tool(verb string) string { return toolPrefix + verb }

// toolDescriptors returns the full ikigenba_agent_* tool set:
// ikigenba_agent_health (the auth proof + diagnostics) plus the ten

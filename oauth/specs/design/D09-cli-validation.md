...
- R-M68L-ADTD: Package `internal/options` MUST export an `Options` struct whose fields are exactly `AuthURL *url.URL`, `TokenURL *url.URL`, `ClientID string`, `Scope string`, `ClientSecret string`, `CallbackHost string`, `Port int`, `CallbackPath string`, `AuthParams []oauth.Param`, `TokenParams []oauth.Param`, `TokenHeaders []oauth.Param`, `NoBrowser bool`, `Timeout time.Duration`, and `Version bool`.

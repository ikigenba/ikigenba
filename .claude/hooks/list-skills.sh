...
echo "Project skills (.agents/skills/<name>/SKILL.md), enumerated by the SessionStart hook. When a request names one or matches its description, read that SKILL.md and follow it before acting:"
for f in "${files[@]}"; do

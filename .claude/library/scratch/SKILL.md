...
`scratch.md` is a temporary storage file for carrying information between sessions.
...
Common use cases:
- **Resume prompts**: Save instructions to help the next session continue where this one left off

...
- **D4** → `project/design/D04.md` — Version production: `bump`/`ship` emit `v`-prefixed SemVer + the release bundle — ids: R-44HU-2IOD, R-45PQ-GAF2, R-201H-8XX0
...
- R-201H-8XX0 → D4 (`project/design/D04.md`)

...
func (r *Recorder) StartRoot(ctx context.Context, op string, detail map[string]any) (rootCtx context.Context, correlationID string) {
	id := correlation.New()
...
func (r *Recorder) StartChain(ctx context.Context, op string, detail map[string]any) (chainCtx context.Context, correlationID string) {

...
// the /srv/ralph/ prefix, so the bare path is /.well-known/oauth-protected-resource.
...
// handleWhoami is the ralph_whoami proof the dashboard's connect skill uses to

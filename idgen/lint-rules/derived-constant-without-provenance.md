...
// changing base or bodyDigits silently invalidates both.
const (
	base       = 36
	bodyDigits = 8
	modulus    = 2821109907456 // 36^8
	inverse    = 2032036425553
)
```
...
const (
	base       = 36
	bodyDigits = 8
	modulus    = int64(math.Pow(base, bodyDigits)) // or an explicit product

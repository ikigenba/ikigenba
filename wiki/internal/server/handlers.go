...
// the /srv/wiki/ prefix, so the bare path is /.well-known/oauth-protected-resource.
...
// handleWhoami is the wiki_whoami proof the dashboard's connect skill uses to

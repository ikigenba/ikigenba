...
- Phase 126 ⬜ realizes R-GSMY-FWWD, R-GTUU-TON2, R-GV2R-7GDR, R-GWAN-L84G, R-H3M1-VUKM, R-H4TY-9MBB — the scope registry: schema migration, name validation, and the store
- Phase 127 ⬜ realizes R-GXIJ-YZV5, R-GYQG-CRLU, R-GZYC-QJCJ, R-H169-4B38, R-H2E5-I2TX, R-H61U-NE20, R-H79R-15SP — the hard wall: scope threaded through pipeline, retrieval, ask, links, orphans, merge

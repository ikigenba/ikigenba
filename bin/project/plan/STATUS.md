...
- Phase 12 ⬜ realizes — (untested tier, D3) — bin/start aborts a service launch loudly, naming the service and the unresolved secret, when a declared `secret` has no keyring entry

...
- D19 → `project/design/D19.md` — Adopt the suite lint contract (`root project/design/D30.md`) at tier `strict` — none (structural; the contract carries no per-service ids)
...
- R-BBON-OZTN → D16 → `project/design/D16.md`
- R-BE4G-GJB1 → D16 → `project/design/D16.md`
...
- R-O1AD-MRKW → D17 → `project/design/D17.md` (adopted from root `project/design/D23.md`)
- R-O2IA-0JBL → D17 → `project/design/D17.md` (adopted from root `project/design/D23.md`)

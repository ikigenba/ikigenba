...
// nginx. Under /srv/cron/ it serves an MCP surface for agents behind the bearer
// gate alongside a human web landing page behind the dashboard session-cookie
// gate. It trusts the X-Owner-Email / X-Client-Id headers nginx injects after a

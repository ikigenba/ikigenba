...
it. You read **only** `project/prompts/brief.md` — never design, plan, or product.
...
1. **Read the brief.** If `project/prompts/brief.md` is missing or empty, make no

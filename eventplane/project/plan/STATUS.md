...
- Phase 05 ✅ realizes R-Z8Y5-5R0C — delete the inline feed guard from outbox.FeedHandler (chassis LoopbackOnly owns loopback-only); replace TestFeed_RejectsIdentityHeaders with the serves-despite-headers test

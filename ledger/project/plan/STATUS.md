...
- Phase 17 ⬜ realizes D17 (fragment slice; no ids) — carry `X-Correlation-Id` across ledger's nginx trust boundary: capture on every gated location, strip on the ungated PRM bootstrap

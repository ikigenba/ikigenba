...
| `research/` | `README.md` — the design-informing research spine (when present); plus free-form `*-research.md` working notes | `README.md`: `/research-mode` (rewritten in place). Other notes: free-form. |

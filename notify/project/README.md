# notify/project — workspace layout

Everything the notify service needs to be **designed, planned, and built**
...
root** (`notify/`), which is also the directory the `ralph` build loop runs
from.
...
| `research/` | `research.md` (spine) — the design-informing research spine; plus free-form `*-research.md` working notes | `research.md`: `/research-mode` (rewritten in place). Other notes: free-form. |

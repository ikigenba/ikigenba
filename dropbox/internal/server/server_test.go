...
const (
	testResourceID = "https://ai.metaspot.org/srv/dropbox/mcp"
...
func TestNewRequiresConfig(t *testing.T) {
	...
	contentStub := http.HandlerFunc(func(http.ResponseWriter, *http.Request) {})
	cases := []struct {
		name string
		opts Options
	}{
		{"no logger", Options{ResourceID: testResourceID, AuthServer: testAuthServer, MCP: mcpStub, Feed: feedStub, Content: contentStub}},
		{"no resource", Options{Logger: logger, AuthServer: testAuthServer, MCP: mcpStub, Feed: feedStub, Content: contentStub}},
		{"no auth server", Options{Logger: logger, ResourceID: testResourceID, MCP: mcpStub, Feed: feedStub, Content: contentStub}},
		{"no mcp", Options{Logger: logger, ResourceID: testResourceID, AuthServer: testAuthServer, Feed: feedStub, Content: contentStub}},
		{"no feed", Options{Logger: logger, ResourceID: testResourceID, AuthServer: testAuthServer, MCP: mcpStub, Content: contentStub}},
		{"no content", Options{Logger: logger, ResourceID: testResourceID, AuthServer: testAuthServer, MCP: mcpStub, Feed: feedStub}},
	}

...
**`prompts/internal/db/migrations/`**: add one new timestamped SQL file created with `bin/new-migration prompts backfill-provider-and-model-aliases`. The file contains two idempotent backfills in a single forward-only script:

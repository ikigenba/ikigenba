...
self-contained `project/prompts/brief.md` that the later steps consume without ever
...
- Read only: `project/plan/STATUS.md`, the one `project/plan/phase-NN.md`,
  `project/design/INDEX.md`, the realized `project/design/DNN.md`, and
  (if needed for intent) `project/product.md`. Read no other phase or Decision
  file.
